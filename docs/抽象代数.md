...
* **公因子：** $ c \vert a, ~ c\vert \Rightarrow $ 称$c$是$a,b$的公因子，如果存在$d$对$a,b$的任一公因子$c$都有$c\vert d$，那么称$d$为$a,b$的公因子，计为$(a,b)$。如果整环$R$的每一对元素都有最大公因子，那么有任意$a,b,c \in R \Rightarrow (cb,ca) = c(a,b)$
